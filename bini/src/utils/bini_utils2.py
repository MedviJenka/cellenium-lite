...
class BiniUtils(Service):
    ...
    def run(self, prompt: str, image_path: str, sample_image: Union[str, list] = '', *, as_dict: bool = False) -> str or dict:
        """backward compatibility method to run image analysis with prompt and optional sample images."""
        return self.run_image(prompt=prompt, image_path=image_path, sample_image=sample_image, as_dict=as_dict)

    def run_image(self, prompt: str, image_path: str, sample_image: Union[str, list] = '', *, as_dict: bool = False) -> Union[str, dict]:
        """Runs the Bini image analysis flow with the provided prompt and image."""
    ...
    def run_text(self, prompt: str, *, as_dict: bool = False) -> Union[str, dict]:
        """Runs the Bini text analysis flow with the provided prompt."""
