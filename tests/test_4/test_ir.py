...
def test_meeting_insights() -> None:
    response = bini.run(
        image_path=r"C:\Users\medvi\OneDrive\Desktop\cellenium-lite\bini\core\data\images\img_5.png",
...
def test_outgoing_calls_under_external_p2p() -> None:
    response = bini.run(
        image_path=r"C:\Users\medvi\OneDrive\Desktop\cellenium-lite\bini\core\data\images\img_3.png",
...
def test_count_rows() -> None:
    response = bini.run(
        image_path=r"C:\Users\medvi\OneDrive\Desktop\cellenium-lite\bini\core\data\images\img_1.png",
...
def test_no_rows() -> None:
    response = bini.run(image_path=r"C:\Users\medvi\OneDrive\Desktop\cellenium-lite\bini\core\data\images\img_2.png",
...
def test_complex_metadata_validations() -> None:
    image = r'C:\Users\medvi\OneDrive\Desktop\cellenium-lite\bini\core\data\images\img_11.png'
...
def test_user_name_displayed_in_recording_row_1() -> None:
    bini.validate_call_metadata_for_each_row(image=r'C:\Users\medvi\OneDrive\Desktop\cellenium-lite\bini\core\data\images\img_1.png',
                                             row=1,
                                             recording_type='Audio',
                                             user_name='st_user2')
